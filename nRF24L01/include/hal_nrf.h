...
/**
 * @brief Enables or disables interrupts on radio
 *
 ...
 *
 * @param uint8_t - setup Byte value with bit set for pipes that uses the dynamic payload feature
 */
...
/**
 * @breif Set radio's address width.
 *
...
/**
 * @breif Get address width for radio.
 *
...
/**
 * @breif Get RX payload width for selected pipe.
 *
...
*/
extern uint8_t hal_nrf_rw( uint8_t value );
//@}
#endif
/**
@}
